...
Check out the [explore](/explore) page to see it in action.
...
* The number of components in your code (specifically for Angular).
...
* [ChartJS Plugin](/plugins/post-processors/charts) - Generate charts definitions that can be used with ChartJS (UI is also available that supports these charts)
* [OpenSearch Plugin](/plugins/post-processors/opensearch) - send the data to OpenSearch instance and visualize with OpenSearch dashboards (comes with docker compose file)
* [Coralogix Plugin](/plugins/post-processors/coralogix) - send the data to your Coralogix account, you can then visualize it using OpenSearch dashboards or Coralogix Dashboards.
