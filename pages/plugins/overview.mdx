...
| Name          | Description       | Is Used By Default
|---------------|------------|--------------------------------------------------------
| ImportsPlugin | Information about all the imports (importedFrom, and imported)   | x          |
| TSFilePlugin      | Get information about functions and files     | x
| HTMLTagsPlugin      | Get all used tags     |  x
| AngularPlugin      | Count the number of components     |
...
| Name          | Description       | Is Used By Default
|---------------|------------|--------------------------------------------------------
| ChartJSPlugin | Generate ChartJS graphs, based on the count of labels, as well as combination of labels and metrics   | x          |
| ConsoleLogPlugin | Output result to console log   |
| CoralogixFinalizer | Send the entire result to Coralogix   |
| OpenSearchFinalizer | Send the entire result to OpenSearch   |
