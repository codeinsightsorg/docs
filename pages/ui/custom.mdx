...
The [code](https://github.com/codeinsightsorg/docs/tree/main/pages/explore) of the [explore](/explore) page is an example of how to use the [Charts Plugin](/plugins/post-processors/charts) to generate charts.
